...
ImGuiManager::ImGuiDraw()
{
	...
	//アクターが移動する際のウィンドウ
	{
		...
		{
			ImGui::Checkbox("Front1", &_front1);
			ImGui::Checkbox("Right1", &_right1);
			ImGui::Checkbox("Up1", &_up1);
			ImGui::Checkbox("Front2", &_front2);
			ImGui::Checkbox("Right2", &_right2);
			ImGui::Checkbox("Up2", &_up2);
		}
